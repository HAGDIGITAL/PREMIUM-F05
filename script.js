...
const targetDate = new Date("2026-08-02T11:00:00+07:00").getTime();
...
if (saveDateBtn) {
    ...
    saveDateBtn.addEventListener("click", () => {
        ...
        const title = "Pernikahan Nabila & Leo";
        const location = "SAUNG AYAM BAKAR MIRASA, PASAR KEMIS, TANGERANG";
        const details = "Kami mengundang Anda untuk menghadiri pernikahan Nabila & Leo.";

        const start = "20260802T110000Z";
        const end = "20260802T050000Z";
...
const coupleVideo = document.querySelector("#couple .bg-video");

const gallery = document.getElementById("gallery");
const galleryVideo = document.querySelector("#gallery .bg-video");


function updateVideo(section, video) {
    ...
    /*
     * Video hanya aktif ketika SECTION
     * benar-benar sedang berada di viewport.
     */
...
updateVideo(couple, coupleVideo);
updateVideo(gallery, galleryVideo);
